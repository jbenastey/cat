        ...
        <div class="container">
            <div class="row">
                <div class="col col-login mx-auto">
                    ...
                    <form class="card" action="<?=base_url('register')?>" method="post">
                        <div class="card-body p-6">
                            <div class="card-title">Buat Akun Baru</div>
                            <div class="form-group">
                                <label class="form-label">Nama</label>
                                <input type="text" class="form-control" name="nama" placeholder="Masukkan nama" required autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label class="form-label">NISN</label>
                                <input type="number" class="form-control" name="nisn" placeholder="Masukkan NISN" required autocomplete="off">
                            </div>
                            <div class="form-group">
